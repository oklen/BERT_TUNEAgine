...
from modules.graph_encoderABDUG2LS import NodeType, NodePosition, EdgeType, Encoder,GraphEncoder
...
class NqModel(nn.Module):
    def __init__(self, my_config,args):
        ...
        self.my_mask = None
        self.args = args
        self.bert_config = AlbertConfig.from_pretrained("albert-base")
#        self.bert_config.gradient_checkpointing = True
#        self.bert_config.Extgradient_checkpointing = True
        self.bert =  AlbertModel.from_pretrained("albert-base",config = self.bert_config)
