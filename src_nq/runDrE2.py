...
from modules.graph_encoderDr3 import Config, EdgeType, NodeType, EdgePosition
from generate_exampleDreamRov3 import InputFeatures, DrExample, AnswerType

from src_nq.modelDR2 import NqModel
