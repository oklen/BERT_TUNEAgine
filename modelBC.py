...
class NqModel(BertPreTrainedModel):
    def __init__(self, bert_config, my_config):
        ...
        self.bert =  AutoModelWithLMHead.from_pretrained("albert-base-v2")
    ...
    def forward(self, input_ids, attention_mask, token_type_ids, st_mask, st_index, edges, start_positions=None,
        ...
        print("ALBERT BEGIN!")
        sequence_output, _ = self.bert(input_ids,  attention_mask,token_type_ids, output_hidden_states=False)
        print("ALBERT DONE!")
